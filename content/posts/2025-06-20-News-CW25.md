+++
title = '2025 06 20 News CW25'
date = 2025-06-18T12:30:22+02:00
draft = true
+++

Comparison of Apicurio over Confluent
What are the key advantages and disadvantages of Apicuri o compared to Confluent?
...
Disadvantages
Maturity and Market Share: While robust and widely used, Confluent Schema Registry has been the de facto standard for Kafka for a longer period, leading to a larger body of community-contributed resources, tutorials, and third-party tool integrations specifically tailored to it.
...
Market Leader with Extensive Ecosystem: Its status as the market leader means there is a vast ecosystem of tools, documentation, and community expertise built around it. Finding skilled developers and operational support is generally easier.
...
Can you provide insights into the cost implications of using Apicurio versus confluent?
Apicurio is included in the Red Hat Application Foundations Subscription (= in the bundle with Kafka).
The bundle also includes additional components like Red Hat build of Apache Camel or Red Hat build of Debezium
See https://www.redhat.com/en/products/application-foundations
Customers need a Red Hat subscription that covers the total maximum number of CPU cores used by the components from the bundle. 
For instance If you have a subscription for 24 cores that is currently fully used for the cores consumed by the Kafka brokers, and your Apicurio deployment will consume 4 cores in total, then you would need to add 4 cores to your existing subscription (currently Red Hat Integration). → Jaroslav Libal (DHL IT Services)
Confluent Schema Registry is essentially free for basic usage, though advanced features like RBAC (Role-Based Access Control) require an enterprise license.

Known Issues and Planned Solutions for Apicurio:
What are the known issues with Apicurio?
What planned solutions or improvements are in place for these issues?
...
More details: Red Hat Build of Apicurio Registry Roadmap Slide:




Resources:
https://docs.redhat.com/en/documentation/red_hat_build_of_apicurio_registry/3.0/html/release_notes_for_apicurio_registry_3.0/registry-relnotes_service-registry#apicurio_registry_known_issues 
https://github.com/apicurio/apicurio-registry/issues
https://docs.redhat.com/en/documentation/red_hat_build_of_apicurio_registry/3.0/html-single/release_notes_for_apicurio_registry_3.0/index
https://docs.google.com/presentation/d/1MWeR3Lsq2s3GJwsiMbAUDCEEkL2Pp7HMBmNr4-EJZuc/edit?slide=id.g31bf7416190_0_0#slide=id.g31bf7416190_0_0

Cost Analysis:
How are the licensing, support, and operational costs for Apicurio?
As already mentioned, it is included in the Application Foundations SKU. For detailed customer pricing and discounts, please ask your SSP.

Excerpt from the world wide price list (Commercial - Direct EMEA EUR Q2 2025)
MW02000
Red Hat Application Foundations, Premium, (2 Cores or 4 vCPUs)
EUR
5,227.00
MW02103
Red Hat Application Foundations, Cluster Edition, Premium, (2 Cores or 4 vCPUs)
EUR
2,614.00
MW04620
Red Hat Application Foundations, Cluster Edition (Bare Metal Node), Premium (1-2 Sockets up to 128 cores)
EUR
23,522.00
MW00448
Red Hat OpenShift Container Platform with Application Foundations, Premium, (2 Cores or 4 vCPUs)
EUR
9,099.00
MW00449
Red Hat OpenShift Container Platform with Application Foundations, Premium, (16 Cores or 32 vCPUs)
EUR
72,794.00
MW00450
Red Hat OpenShift Container Platform with Application Foundations, Premium, (64 Cores or 128 vCPUs)
EUR
274,447.00
...
Will either solution obstruct or hinder our existing infrastructure?
...
How well can Apicurio be integrated with our current systems?
